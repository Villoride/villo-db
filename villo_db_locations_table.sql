...
CREATE TABLE `locations_table` (
  ...
  `Last_date_time_update_on` datetime DEFAULT NULL,
  `deriver_status` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
...
INSERT INTO `locations_table` VALUES (1,26,'HosaRoad',11.8825118,11.8825118,NULL,NULL);
